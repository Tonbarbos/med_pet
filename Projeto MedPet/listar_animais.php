...
if($_SESSION['tut']){
    ...
    $select="SELECT anim_id as id, tutores_tut_id as idTutor, veterinarios_vet_id as idVet, anim_nome as nome from animais where veterinarios_vet_id = ". $_SESSION['id_vet'];
}
